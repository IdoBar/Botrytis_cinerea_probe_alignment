...
Both the initial QC and the mapping results show that there was a contamination in the DNA samples of at least three isolates: 16CUR019, 15CUR003, FT15023. This conclusion was obvious from the different GC content signatures of the three isolates (`r figs(name="GC_cont",display="cite")`) compared with the other isolates and from the low mapping rates of these isolates to the _B. cinerea_ reference genome (see bottom of `r tbls(name="mapping_rates",display="cite")`).  
FT15023 in particular mapped at low rate to the _B. cinerea_ reference genome (~7%).  
